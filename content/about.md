...
Lê Nhựt Nam (Vietnamese format) is a graduated Computer Science student with recieved Bachelor's Degree of Computer Science from  <a href="https://en.hcmus.edu.vn/" target="_blank">University of Science - Vietnam National University HCMC</a>. In August 2021, he joined as a student and master student in the BSc-MSc Programme in Computer Sciences for specialized students. Currently, he is studying as master in <b>Computer Sciences</b> & <b>Applied Mathematics</b> (Double Master Programs) at his university.

For research working, he joined as research student @ Knowledge Graphs Team under the supervision of <a href="https://www.fit.hcmus.edu.vn/~lnthanh/">Thanh Le</a> and working independently on his research topics. Beside that, he worked as Visiting Lecturer for <a href="https://www.fit.hcmus.edu.vn/">Deperment of Computer Science, Faculty of Information Technology @ HCMUS</a>. For industry experience, he is working as AI Engineer, specialized in Computer Vision & Digital Image Processing.

His bachelor's research focuses on knowledge graphs and knowledge graph completion. In particular, the topic for attention is the link prediction task, which is a fundamental task for completing multi-relational data such as knowledge graphs. His interested fields are information geometry, combinatorial optimization, and algorithms for optimization. Furthermore, he also has a huge interest in theoretical computer science and mathematical. Summary his research areas and interested fields:
> Graph algorithms
...
Objectives in researching:
> His research ambitions revolve around the assumption that the world is actually simple. In view of this, theories are developed through the use of mathematical formulations that explain the universal works. The beautiful part of Mathematics is Graph Theory, the powerful language, which allows us to formalise essentially and reach the final answer whatever problems we have.
